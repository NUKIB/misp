...
Configure::write('Error', array(
	'handler' => function ($code, $description, $file = null, $line = null) {
        // Skip logging when session lock could not be acquire
        if ($code === E_NOTICE && $description === 'session_start(): Acquire of session lock was not successful') {
            return;
        }
