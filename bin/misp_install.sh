...
su-exec apache php composer.phar --no-cache require --update-no-dev symfony/polyfill-php80:v1.18.1 sentry/sdk jumbojett/openid-connect-php cakephp/cakephp:2.10.24 supervisorphp/supervisor guzzlehttp/guzzle php-http/message
