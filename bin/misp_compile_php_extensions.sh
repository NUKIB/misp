...
mkdir /tmp/simdjson
cd /tmp/simdjson
download_and_check https://github.com/JakubOnderka/simdjson_php/archive/37f91eb4eda66d4e03ff83af6e91269fc0dcc0dd.tar.gz e4dd88d1c0a33a45ad1154f6065587ca2ce1724f6eeac423522676df5343c22a
phpize
...
mkdir /tmp/redis
cd /tmp/redis
download_and_check https://github.com/phpredis/phpredis/archive/a551fdc94c14d7974f2303cd558f7bd3e0fd91d6.tar.gz 98b34981685e72d11ff5e8ff6ffcde922eb5e5f6fbe251900360bd9eb2665f13
phpize
