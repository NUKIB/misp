...
mkdir /tmp/zstd
cd /tmp/zstd
download_and_check https://github.com/kjdev/php-ext-zstd/archive/df25e279720b544b9764bae0e74550a09262a779.tar.gz 1c56ecb801d054f66641bdbff116c1be78b1a38e2cfb905fab9ff27649640bb2
cd zstd
